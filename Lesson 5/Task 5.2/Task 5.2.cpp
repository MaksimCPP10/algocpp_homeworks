...
int main()
{
    ...
    std::cout << "}\n";
        ...
        std::cout << "\nКоманды для \"путешествия\" по пирамиде:\n\n";
        std::cout << "up\t — перейти к родителю;\n";
        std::cout << "left\t — перейти к левому потомку;\n";
        std::cout << "right\t — перейти к правому потомку;\n";
        std::cout << "exit\t — завершить работу программы.\n";
